defmodule RummagePhoenixExampleWeb.ProductControllerTest do
  use RummagePhoenixExampleWeb.ConnCase

  alias RummagePhoenixExample.Store

  @create_attrs %{available: true, name: "some name", price: 120.5}
